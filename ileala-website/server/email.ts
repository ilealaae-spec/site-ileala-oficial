        ...
        <html>
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
              ...
              <p>
                <a href="${siteUrl}" style="color: #255238; text-decoration: none;">Visit our website</a> | 
                <a href="${siteUrl}/contact" style="color: #255238; text-decoration: none;">Contact us</a>
              </p>
            </div>
          </body>
        </html>
        ...
        <html>
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #ffffff; padding: 40px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <p style="color: #666; font-size: 14px;">Need help? Contact us anytime at <a href="mailto:contact@ileala.ae" style="color: #255238;">contact@ileala.ae</a></p>
            </div>
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #ffffff; padding: 40px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: #f5f5f5; padding: 20px; border-radius: 5px; margin: 20px 0;">
                ...
                <p style="margin: 5px 0 0 0; font-size: 24px; font-weight: bold; color: #255238;">#${orderId}</p>
              </div>
              
              <h3 style="color: #255238; margin-top: 30px;">Order Details</h3>
              
              <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                <thead>
                  <tr style="background: #f5f5f5;">
                    <th style="padding: 10px; text-align: left; border-bottom: 2px solid #255238;">Item</th>
                    <th style="padding: 10px; text-align: center; border-bottom: 2px solid #255238;">Qty</th>
                    <th style="padding: 10px; text-align: right; border-bottom: 2px solid #255238;">Price</th>
                  </tr>
                </thead>
                <tbody>
                  ${itemsHtml}
                ...
                <tfoot>
                  <tr>
                    ...
                    <td style="padding: 15px 10px; text-align: right; font-weight: bold; font-size: 18px; color: #255238;">${formatPrice(totalAmount)}</td>
                  </tr>
                </tfoot>
              </table>
              ...
              <p style="color: #666; font-size: 14px;">Questions? Contact us at <a href="mailto:contact@ileala.ae" style="color: #255238;">contact@ileala.ae</a></p>
            </div>
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #ffffff; padding: 40px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <p style="color: #666; font-size: 14px; margin-bottom: 0;">
                ...
                <a href="${siteUrl}/contact" style="color: #255238; text-decoration: underline;">contact us</a> to unsubscribe.
              </p>
            </div>
          ...
          <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #ffffff; padding: 40px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <div style="text-align: center; margin: 20px 0; padding: 15px; background: #f5f5f5; border-radius: 5px;">
                ...
                <a href="${resetUrl}" style="color: #255238; text-decoration: underline; font-size: 14px; word-break: break-all; display: block;">
                  ${resetUrl}
                </a>
              </div>
              
              <p style="color: #666; font-size: 14px; margin-top: 20px;">Or copy and paste this link into your browser:</p>
              <p style="color: #255238; font-size: 12px; word-break: break-all; background: #f9f9f9; padding: 10px; border-radius: 3px; font-family: monospace;">${resetUrl}</p>
...
export async function sendGiftCardEmail(
  ...
  const messageSection = message ? `
    <div style="background: #f9f9f9; padding: 20px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #255238;">
      ...
      <p style="color: #255238; font-size: 14px; margin: 15px 0 0 0; text-align: right;">— ${displaySender}</p>
    </div>
  ` : '';
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
        ...
        <div style="background: #ffffff; padding: 40px; border: 1px solid #e0e0e0; border-top: none;">
          <div style="text-align: center; margin-bottom: 30px;">
            ...
            <h2 style="color: #255238; margin: 15px 0 0 0; font-size: 24px;">You've received a gift!</h2>
          ...
          <div style="background: #f5f5f5; padding: 20px; border-radius: 8px; margin-top: 25px;">
            <h3 style="color: #255238; margin: 0 0 15px 0; font-size: 16px;">How to use your Gift Card:</h3>
            <ol style="color: #666; font-size: 14px; margin: 0; padding-left: 20px; line-height: 2;">
              <li>Browse our exclusive collection at <a href="${siteUrl}/shop" style="color: #255238;">ileala.ae</a></li>
...
export async function sendTierUpgradeEmail(
  ...
  const tierBenefits: Record<string, string[]> = {
    green: [
      'Exclusive Newsletter with insider content',
      'Access to Private Sales',
      'Birthday surprise',
    ],
    silver: [
      'Free Standard Shipping within UAE',
      'Birthday Gift',
      'Everything from Green tier',
    ],
    gold: [
      'Free Express Shipping',
      'Early Access to new collections (24h before)',
  ...
  const newTierInfo = tierInfo[newTier] || tierInfo.green;
  const benefits = tierBenefits[newTier] || [];

  logger.info(`[Email] Sending tier upgrade email to ${email} (${oldTier} -> ${newTier})`);

  const benefitsList = benefits.map(b => `
    <li style="padding: 8px 0; border-bottom: 1px solid #f0f0f0;">
      <span style="color: #255238; margin-right: 8px;">✓</span> ${b}
    </li>
  `).join('');
  ...
  const html = `
    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
        ...
        <div style="background: #ffffff; padding: 40px; border: 1px solid #e0e0e0; border-top: none;">
          <div style="text-align: center; margin-bottom: 30px;">
            <p style="color: #666; font-size: 48px; margin: 0;">🎉</p>
            <h2 style="color: #255238; margin: 15px 0 0 0; font-size: 26px;">Congratulations, ${displayName}!</h2>
            <p style="color: #666; font-size: 16px; margin: 15px 0 0 0;">
              You've reached a new level in our loyalty program
            </p>
          </div>

          <!-- New Tier Badge -->
          <div style="background: ${newTierInfo.gradient}; padding: 25px; border-radius: 15px; text-align: center; margin: 25px 0; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
            <p style="color: rgba(255,255,255,0.8); font-size: 12px; margin: 0; letter-spacing: 2px; text-transform: uppercase;">Your New Tier</p>
            <p style="color: #ffffff; font-size: 36px; font-weight: bold; margin: 10px 0; text-transform: uppercase; letter-spacing: 3px;">
              ${newTierInfo.displayName}
            </p>
          </div>

          <div style="background: #f9f9f9; padding: 25px; border-radius: 10px; margin: 25px 0;">
            <h3 style="color: #255238; margin: 0 0 15px 0; font-size: 18px;">🎁 Your New Benefits</h3>
            <ul style="list-style: none; padding: 0; margin: 0; color: #333; font-size: 15px;">
              ${benefitsList}
            </ul>
          </div>

          <p style="color: #666; font-size: 15px; text-align: center; margin: 25px 0;">
            Thank you for being a loyal ILE ALA customer. We're thrilled to have you with us on this journey!
          </p>
          ...
          <div style="text-align: center; margin-top: 25px; padding-top: 20px; border-top: 1px solid #e0e0e0;">
            <p style="color: #999; font-size: 13px; margin: 0;">
              Keep shopping to unlock even more exclusive rewards!
            </p>
          </div>
        </div>
  ...
  try {
    const result = await getResend().emails.send({
      from: FROM_EMAIL,
      to: email,
      subject: `🎉 Congratulations! You've reached ${newTierInfo.displayName} tier at ILE ALA`,
      html,
    });

    logger.info(`[Email] Tier upgrade email sent successfully to ${email}`);
    logger.debug(`[Email] Resend API response:`, JSON.stringify(result));
    return true;
  } catch (error) {
    logger.error('[Email] ERROR sending tier upgrade email:', error);
    if (error instanceof Error) {
      logger.error('[Email] Error details:', { message: error.message, stack: error.stack });
    }
    return false;
