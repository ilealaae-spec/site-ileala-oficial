      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600">
            {language === 'en' 
              ? 'No home accents products available. Please add products in Admin Panel.' 
              : 'Nenhum produto de artigos para casa disponível. Por favor, adicione produtos no Painel Admin.'}
          </p>
        </div>
      </div>
    );
        ...
        <div className="container h-full flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground">
              {language === 'en' 
                ? 'Elegant cushions and hand towels for your home' 
                : 'Almofadas e toalhas elegantes para sua casa'}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 bg-muted/30">
        <div className="container">
          <div className="max-w-2xl mx-auto relative">
            ...
            <input
              type="text"
              placeholder={language === 'en' ? 'Search home accents...' : 'Buscar artigos para casa...'}
              value={searchQuery}
...
>>>>>>> 426dd4d43 (Migração completa: Sanity CMS → PostgreSQL via tRPC)
            ...
            <div className="text-center py-20">
              <p className="text-xl text-muted-foreground">
                {language === 'en' 
                  ? 'No home accents products available at the moment' 
                  : 'Nenhum produto de artigos para casa disponível no momento'}
              </p>
            </div>
          )}
        </div>
