...
export default function About() {
  ...
  // Helper function to get localized specialty text
  const getSpecialtyText = (artisan: any) => {
  ...
  // Helper function to get localized bio
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-primary">{getSpecialtyText(artisan)}</p>
                      </div>
                    </div>
